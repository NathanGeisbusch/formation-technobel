...
public interface ParserService {
  ...
  ParserEditDTO getEditable(PackageId id, String userEmail);

  CreatedDTO create(PackageCreateForm form, String userEmail);

  void update(PackageId id, ParserInfoForm form, String userEmail);
  ...
  void updateBuilderCode(PackageId id, HttpServletRequest requestd, String userEmail);

  void updateDocCode(PackageId id, HttpServletRequest requestd, String userEmail);
}
